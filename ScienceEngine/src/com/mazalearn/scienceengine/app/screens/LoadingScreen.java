...
public class LoadingScreen extends AbstractScreen {
    ...
    public void show() {
        ...
        TextureAtlas atlas = ScienceEngine.assetManager.get("image-atlases/loading.pack", TextureAtlas.class);
    ...
    public void render(float delta) {
        ...
        percent = Interpolation.linear.apply(percent, ScienceEngine.assetManager.getProgress(), 0.1f);
