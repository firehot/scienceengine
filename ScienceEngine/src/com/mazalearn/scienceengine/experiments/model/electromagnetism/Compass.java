 ...
 */
public class Compass extends FieldElement implements ModelElement, SimpleObserver {
    ...
    // A reusable vector
    private MutableVector2D _someVector;
    ...
    public Compass( AbstractMagnet magnetModel, IClock clock ) {
        ...
        _someVector = new MutableVector2D();

        MutableVector2D fieldStrength = _magnetModel.getBField( getLocation() );
    ...
    private static abstract class AbstractBehavior implements IBehavior {
        ...
        public abstract void setDirection( MutableVector2D fieldVector, double dt );
