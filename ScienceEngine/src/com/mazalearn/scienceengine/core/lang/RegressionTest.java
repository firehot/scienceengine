...
public class RegressionTest {
    ...
    public static void main(String[] args) {
        ...
        expect("42.0", "if(1, 42, 137)");
        expect("42", "'4' + '2'");
        expect("42", "if('2' = '2', '42', '137')");
        ...
        Variable variable = Variable.make("variable.x");
        variable.setValue(1.1);
        Variable str = Variable.make("str");
        str.setValue("a string");
        x.setValue(1.1);
