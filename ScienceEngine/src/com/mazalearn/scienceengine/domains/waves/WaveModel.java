...
public class WaveModel extends AbstractScience2DModel {
  ...
  public void initializeConfigs(List<IModelConfig<?>> modelConfigs) {
    modelConfigs.add(new AbstractModelConfig<String>("GenMode", Attribute.GenMode, GenMode.values()) {
     public String getValue() { return getGenMode(); }
     public void setValue(String value) { setGenMode(value); }
     public boolean isPossible() { return true; }
   });

   modelConfigs.add(new AbstractModelConfig<String>("EndType", Attribute.Boundary, EndType.values()) {
     public String getValue() { return getEndType(); }
     public void setValue(String value) { setEndType(value); }
     public boolean isPossible() { return true; }
   });

   modelConfigs.add(new AbstractModelConfig<Float>("Frequency", Attribute.Frequency, 0, 1) {
    ...
    modelConfigs.add(new AbstractModelConfig<Float>("Tension", Attribute.Tension, 1, 10) {
      public Float getValue() { return getTension(); }
      public void setValue(Float value) { setTension(value); }
      public boolean isPossible() { return true; }
    });

    modelConfigs.add(new AbstractModelConfig<Float>("PulseWidth", Attribute.PulseWidth, 5, 20) {
    ...
    modelConfigs.add(new AbstractModelConfig<Float>("Amplitude", Attribute.Amplitude, 0, 100) {
    ...
    modelConfigs.add(new AbstractModelConfig<Float>("Damping", Attribute.Damping, 0, 0.5f) {
