...
public class ProfileSyncerTest {
  ...
  private static final long TIME_NOW = 123456L;
  ...
  public void testGetUserSyncProfile_NoUpdates() {
    ...
    String s = profileSyncer.getUserSyncProfile(serverProfile, clientProfile);
  ...
  public void testGetUserSyncProfile_YouBehindOnClient() {
    ...
    s = profileSyncer.getUserSyncProfile(serverProfile, clientProfile);
    assertEquals(expected, s); 
  }
  ...
  public void testGetUserSyncProfile_ReInitialize() {
    String expected= "{\"client\":{\"clientjson\":\"test\"},\"social\":{\"socialjson\":\"test\"},\"lastupdated\":{\"client\":10,\"BarMagnet\":30,\"social\":30,\"server\":20},\"server\":{\"serverjson\":\"test\"},\"topicStats\":{\"BarMagnet\":{\"Guru\":10}}}";
    clientUpdates.clear();
    String s = profileSyncer.getUserSyncProfile(serverProfile, clientProfile);
    assertEquals(expected, s);
  }
  ...
  public void testGetUserSyncProfile_TopicStatsForced() {
    String expected= "{\"lastupdated\":{\"BarMagnet\":30},\"topicStats\":{\"BarMagnet\":{\"Guru\":10}}}";
