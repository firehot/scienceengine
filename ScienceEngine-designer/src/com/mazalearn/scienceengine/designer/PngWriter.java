 ...
 * are not allowed to use Java 2D, but the usage of a pure-Java image libary
 * like Sanselan (http://incubator.apache.org/sanselan/site/index.html) might be
 * preferable in a production application.
 * 
 * @author schwardo@google.com (Don Schwarz)
 */
public class PngWriter {
  private static final byte[] HEADER = new byte[] { -119, 80, 78, 71, 13, 10,
      26, 10, };
  ...
  public static byte[] generateImage(Pixmap source) throws IOException {
    ...
    header.write(6); // direct model // Colortype ARGB
  ...
  private static void writeUnsignedInt(OutputStream out, long value)
      throws IOException {
